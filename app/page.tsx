...
interface SidebarBodyProps extends React.ComponentPropsWithRef<"div"> {
  collapsed?: boolean;
}

function SidebarBody({collapsed = false, className, ...props}: SidebarBodyProps) {
  return (
    <div
      {...props}
      className={clsx(
    ...
    <>
      ...
      */}
      <div>
        ...
        >
          {/* Sidebar component, swap this element with another sidebar if you like */}
          <SidebarBody className="border-r border-gray-200" collapsed={sidebarCollapsed} />
        </div>
        ...
        >
          <div className="px-4 sm:px-6 lg:px-8 h-100">
            ...
            <button
              ...
              className="mb-4 p-2 rounded-full bg-white shadow-md"
            >
              Toggle sidebar
            </button>
            ...
            <div className="rounded-lg shadow">
              <div className="relative h-[300px] overflow-hidden rounded border border-dashed border-gray-400 opacity-75">
